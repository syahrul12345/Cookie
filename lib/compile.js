...
module.exports = {
  compile:function(fullpath) {
    ...
    console.log("Compiling %s",path.basename(fullPath))
...
function writeOutput(compiled, buildPath) {
    ...
    for (let contractFileName in compiled.contracts) {
        ...
        //saves the bytecode to a binary
        console.log('Writing: ', contractName + '.bin');
        fs.writeFile(
            path.resolve(buildPath,contractName+'.bin'),
